...
import { BanIcon, RefreshCcwIcon, TrashIcon, WrenchIcon } from "lucide-react";
      ...
      <Badge variant="outline" className="text-muted-foreground px-1.5">
        {(() => {
          switch (row.original.status) {
            case "Running":
              return <IconCircleCheckFilled className="fill-green-500" />;
            case "Creating":
              return <IconLoader className="animate-spin" />;
            case "Restarting":
              return <IconRotateClockwise2 className="animate-spin" />;
            case "Stopping":
              return <IconPlayerPause className="" />;
            case "Error":
              return <IconExclamationCircleFilled className="fill-red-500" />;
            case "Offline":
              return <IconBan />;
            default:
              return;
